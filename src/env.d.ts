...
interface ImportMetaEnv {
  ...
  readonly VITE_AVAILABILITY_INPERSON_CATEGORY_ID?: string;
  readonly VITE_AVAILABILITY_INPERSON_EVENT_ID?: string;
  readonly VITE_AVAILABILITY_TELEHEALTH_CATEGORY_ID?: string;
  readonly VITE_AVAILABILITY_TELEHEALTH_EVENT_ID?: string;
  ...
  readonly VITE_FEATURE_APPOINTMENT_FAB_ENABLED?: string;
  readonly VITE_FEATURE_APPOINTMENT_FAB_PAYMENT_ENABLED?: string;
