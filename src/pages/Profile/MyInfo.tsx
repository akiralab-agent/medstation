...
export function MyInfo() {
  ...
  const menuItems = [
    ...
    { id: 'password', icon: Key, label: t('profile.changePassword'), path: '/profile/change-password' },
    { id: 'terms', icon: FileCheck, label: t('profile.termOfUse'), path: '/profile/terms' },
    { id: 'delete', icon: Trash2, label: t('profile.deleteAccount'), path: '/profile/delete-account' },
  ];
